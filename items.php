 ...
 <?php while($data=$result ->fetch_assoc()){?>
    ...
    <div class="card mb-3">
          <div class="row no-gutters">
            ...
            <div class="col-md-8">
              <div class="card-body">
              <h5 class="card-title">Item Number: <?php echo $data['id']; ?></h5>
...
<!-- Edit and delete button -->
          ...
          <div class="col-md">
          <div class="d-flex justify-content-end">
            <a href="edit.php?id=<?php echo $data['id']; ?>&category=<?=$category?>" class="btn btn-primary">Edit</button></a>
            <a onClick="return confirm('Are you sure you want to delete this item?')" href="delete.php?id=<?php echo $data['id']; ?>&category=<?=$category?>&page=items" class="btn btn-danger" >Delete</button></a>
